...
`tools/list` at `https://gateway.pipeworx.io/conspiracy-theory/mcp` returns the tools in the table
...
```json
{
  "mcpServers": {
    "conspiracy-theory": {
      "command": "npx",
      "args": ["-y", "@pipeworx/mcp-conspiracy-theory"]
    }
  }
}
```
...
```bash
npx -y @pipeworx/mcp-conspiracy-theory
```
